...
public class ArrestJoinDriver extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
	...
	job.getConfiguration().set(DatasetKeyInputFormat.KITE_DATASET_NAME,
			PlayByPlayDriver.PHASE_ONE_MR);
	job.getConfiguration().set(DatasetKeyInputFormat.KITE_REPOSITORY_URI,
			inputRepositoryUri);
