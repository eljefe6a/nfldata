...
for input in sys.stdin.readlines():
	...
	game, drive, play, playtype, quarter, gameminutes, gameseconds, playdesc = input.strip().split("\t")
	...
	print currentplaytype + "\t" + currentmaxplay + "\t" + game + "\t" + drive + "\t" + play + "\t" + quarter + "\t" + gameminutes + "\t" + gameseconds + "\t" + playdesc
